        ...
        <section className="glass-panel rounded-xl p-8 md:p-16 relative overflow-hidden group scroll-shrink-hero mb-8 transition-all duration-300 mt-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 relative z-10 justify-center">
                <div className="relative flex-shrink-0 animate-float order-first">
                    <div className="w-40 h-40 md:w-56 md:h-56 rounded-full p-[2px] bg-gradient-to-br from-primary via-blue-500 to-transparent shadow-[0_0_40px_rgba(59,130,246,0.3)]">
                    ...
                    <div className="absolute bottom-6 right-4 w-6 h-6 bg-emerald-500 border-4 border-[#0a0a0a] rounded-full animate-pulse"></div>
                </div>
                ...
                <div className="text-center md:text-left flex-1 min-w-0 max-w-2xl">
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-slate-900 dark:text-white mb-2 tracking-tighter leading-[0.9]">
                        {heroData.name}<br />
                        <span className="bg-gradient-to-r from-purple-500 to-purple-700 dark:from-purple-400 dark:to-purple-700 bg-clip-text text-transparent">{heroData.surname}</span>
                    </h1>
                    ...
                    <div className="scroll-fade-content">
                        <p className="text-slate-400 text-base md:text-lg mb-8 leading-relaxed max-w-xl mx-auto md:mx-0">
                            {heroData.description}
                        </p>

                        <div className="flex flex-wrap justify-center md:justify-start gap-4">
                            <button className="px-8 py-3.5 rounded-lg bg-primary hover:bg-blue-600 text-white font-medium transition-all shadow-lg shadow-primary/20 hover:shadow-primary/40 flex items-center gap-2 group/btn">
                                <span className="material-icons text-sm group-hover/btn:animate-bounce">download</span>
                                Download CV
                            </button>

                            <a className="px-8 py-3.5 rounded-lg glass-panel hover:bg-white/5 text-white font-medium transition-all flex items-center gap-2 border border-white/5 hover:border-white/20" href="#contact">
                            ...
                            <div className="flex items-center gap-3 ml-2 pl-4 border-l border-white/10">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="w-10 h-10 rounded-lg flex items-center justify-center text-slate-500 hover:text-[#0077b5] hover:bg-white/5 transition-all"
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="w-10 h-10 rounded-lg flex items-center justify-center text-slate-500 hover:text-[#25D366] hover:bg-white/5 transition-all"
                                >
