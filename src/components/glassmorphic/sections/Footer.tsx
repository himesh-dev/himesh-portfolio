    ...
    return (
        <footer className="relative z-10 glass-header border-t border-white/10 mt-auto">
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-white/5 pb-12">
                    ...
                    <div className="md:col-span-1 flex flex-col justify-center items-start md:items-end gap-4">
                        <button
                            onClick={scrollToTop}
                        ...
                        <p className="text-slate-500 text-sm text-right">
                            &copy; 2018 All rights reserved.<br />Made with ❤️ by Himesh
                        </p>
                    </div>
                </div>
            </div>
